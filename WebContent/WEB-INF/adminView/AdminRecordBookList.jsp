...
<html lang="en">
  <head>
    ...
    <title>AdminRecordBookList.jsp</title>
...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="css/AdminRecordBookList.css" rel="stylesheet">
...
<script>
	...
	$(function()
	{
		...
		{
			// alert("확인");
			$(location).attr("href", "adminrecordcardlist.action");
		});
	});
...
<div class="container-fluid" id="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="main_header">
			<button type="button" class="btn btn-default" id="cardBtn">여행카드</button>
			<button type="button" class="btn btn-primary" id="bookBtn">여행책</button>
		</div>
       <div class="main_list">
				...
				<tbody>
					<c:forEach var="book" items="${list }">
						<tr>
							<td>${book.book_num }</td>
							<td>
								<a href="adminrecordbook.action?book_num=${book.book_num }">
									${book.book_title }
								</a>
							</td>
	...
	<form action="adminrecordbooklist" method="get" id="searchForm" class="form-inline">
