...
<html lang="en">
  <head>
    ...
    <title>AdminMemberBookList.jsp</title>
...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link href="css/dashboard.css" rel="stylesheet">
   <link href="css/AdminMemberBookList.css" rel="stylesheet">
...
<!--    <div style="width: 1280px; margin: auto;">    
 ...
 --><!--    <div style="display:inline-block; vertical-align:top;"> -->
   ...
   <br>
   <div class="btnSet">
       <button type="button" class="btn btn-default control btns updateBtn" onclick="location.href='adminmemberbooklist.action?sign_num=${memberInfo.sign_num}' ">여행책</button>
    	...
    	<thead>
					...
					-->
					 <c:forEach  var="bl" items="${bookList}">
							<tr>
								<td>${bl.book_num }</td>
								<td><a href="adminrecordbook.action?book_num=${bl.book_num}">${bl.book_title }</a></td>
								<td>${bl.book_date}</td>
								<td>${bl.book_blind }</td>
							</tr>
					</c:forEach>
