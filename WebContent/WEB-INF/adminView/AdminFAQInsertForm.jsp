...
<html lang="en">
  <head>
    ...
    <title>AdminFAQInsertForm.jsp</title>
...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="css/AdminFAQInsertForm.css" rel="stylesheet">
...
<div class="container-fluid" id="container-fluid">
  <div class="row">
	...
	<form action="adminfaqinsert.action" method="post" id="faqForm">
		<div class='selectBox'>
		...
		<div class="titleForm">
			...
			<input type="text" class="form-control" id="title" placeholder="질문을 입력해주세요."
		...
		<div class="contentForm">
			...
			<div class="mb-3">
			  ...
			  placeholder="내용을 입력해주세요." style="font-size: 15px;" name="faq_answer"></textarea>
			</div><!-- 내용입력 폼 -->
		</div>
