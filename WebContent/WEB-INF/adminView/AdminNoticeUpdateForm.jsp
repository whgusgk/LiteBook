...
<html lang="en">
  <head>
    ...
    <title>AdminNoticeUpdateForm.jsp</title>
...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="css/AdminNoticeUpdateForm.css" rel="stylesheet">
...
<script>
	...
	$(function()
	{
		...
		{
			// alert("확인");
			$(location).attr("href", "adminnotice.action?notice_num=" + $(".cancelBtn").val());
		});
...
<div class="container-fluid" id="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	  ...
	  <form action="adminnoticeupdate.action" method="post" id="noticeForm">
		<div class="titleForm">
			 <div class="question">
			 <p>
			 ...
			 <div class="question_input">
				<input type="text" class="form-control" id="title" value="${notice.notice_title }"
	...
	<div class="contentForm">
		...
		<div class="answer_textArea">
			<textarea class="form-control formTextarea" id="content" rows="25" style="font-size: 15px;" name="notice_content">
	...
	<div class="buttonLine" style="text-align: right;">
		<button type="button" class="btn updateBtn" style="margin-right: 10px; background-color: #1DB1F8;">확인</button>
		<button type="button" class="btn cancelBtn" style="background-color: #BDBDBD" value="${notice.notice_num }">취소</button>
	</div>
	</form>
