...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="css/AdminMyInfo.css" rel="stylesheet">
...
<script>
	...
	$(function()
	{
		...
		{
			//alert("수정버튼 클릭!");
			$(location).attr("href", "adminmyinfoupdateform.action");
		});
   ...
   <div class="tableDiv">
      <table class="table table-bordered">
       <tbody>
         ...
         <tr>
            <th>생년월일</th>
            <td>${list.admin_birth }</td>
            <th>성별</th>
            <td>${list.gender }</td> <!-- 남성, 여성, 선택안함 -->
         </tr>
         <tr>
            <th>이메일</th>
      ...
      <br>
      <div class="btnSet">
      <button type="button" class="btn btn-primary control updateBtn" id="addBtn">수정</button>
      </div>
