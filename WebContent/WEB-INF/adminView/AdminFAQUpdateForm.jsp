...
<html lang="en">
  <head>
    ...
    <title>AdminFAQUpdateForm.jsp</title>
...
<link href="assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="css/AdminFAQUpdateForm.css" rel="stylesheet">
...
<script>
	...
	$(function()
	{
		$(".updateBtn").click(function()
		{
			...
			$("#qcategory").val(${faq.qcategory_num});
...
<div class="container-fluid" id="container-fluid">
  <div class="row">
	...
	<div class="content">
	<form action="adminfaqupdate.action" method="post" id="faqForm">
		<div class='selectBox'>
			<select id="qcategory" name="qcategory_num">
				<option value="0">FAQ 카테고리</option>
		...
		<div class="titleForm">
			<span style="font-size: 25px;">질문</span>
			<input type="text" class="form-control" value="${faq.faq_question }"
			style="width: 1000px; height:40px; float: right; font-size: 15px;" name="faq_question">
		</div>
		
		<br>
		
		<div>
			<p style="font-size: 25px;">답변</p>
		</div>
		
		<div class="contentForm">
			<!-- <span style="font-size: 25px; border: 1px solid red;">내용</span> -->
			<div class="mb-3">
			  <textarea class="form-control formTextarea" rows="25" style="font-size: 15px;" name="faq_answer">
			  	${fn:replace(faq.faq_content, replaceWord, '<br>' }
			  </textarea>
			</div><!-- 내용입력 폼 -->
		</div>
		...
		<div class="buttonLine" style="text-align: right;">
			<button type="button updateBtn" class="btn" style="margin-right: 10px; background-color: #1DB1F8;">확인</button>
			<button type="button cancelBtn" class="btn" style="background-color: #BDBDBD">취소</button>
		</div>
	</form>
</div>
