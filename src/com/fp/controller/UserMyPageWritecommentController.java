...
public class UserMyPageWritecommentController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			// 페이징 문자열
			String pageUrl = "usermypagewritecomment.action";
			...
			// 댓글 리스트
			commentList = dao.commentList(sign_num, start, end);
			...
			// 뷰 페이지 set
			mav.setViewName("/WEB-INF/userView/UserMyPageWritecomment.jsp");
