...
public class UserBookInsertController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			int bookInsertCheck = dao.bookInsert(book);
			if(bookInsertCheck < 1)
			...
			{
				dao.bookedCardInsert(String.valueOf(book_num), cardNums[i]);
			}
