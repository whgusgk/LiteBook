...
public class UserNoteScrapSelectListController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			// 총 게시물 개수
			int count = scrapDAO.scrapListCount(sign_num);
			...
			scrapList = scrapDAO.scrapList(start, end, sign_num);
			...
			String pageUrl = "usernotescrapselectlist.action" + param;
			...
			mav.setViewName("/WEB-INF/userView/UserNoteScrapSelectList.jsp");
