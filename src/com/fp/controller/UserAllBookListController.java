...
public class UserAllBookListController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		*/
		...
		ArrayList<BookDTO> allBookList = new ArrayList<BookDTO>();
		...
		try
		{
			...
			int totalPage = page.pageAllBookCount(count);
			...
			allBookList = dao.allBookList(start, end);
			mav.addObject("allBookList", allBookList);
			
			
			//추후에 인기여행책 리스트를 위한 책관련 값을 넘겨줘야함.
			mav.setViewName("/WEB-INF/userView/UserAllBookList.jsp");
